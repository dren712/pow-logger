...
exports.ACHIEVEMENT_DEFINITIONS = [
    ...
    },
    {
        ...
        rarity: 'Rare',
        evaluate: (logs) => {
            const solanaLogs = logs.filter((l) => l.protocols?.some((p) => /solana|spl|anchor|metaplex|helius/i.test(p)));
...
function evaluateAchievements(logs, currentStreak, longestStreak) {
    return exports.ACHIEVEMENT_DEFINITIONS.map((def) => {
