...
const policyEngine_1 = require("../app/lib/policyEngine");
class ProvnClient {
    constructor(options) {
     ...
     */
    async checkEligibility(wallet, policy) {
     ...
     */
    static generateProofPacket(passport) {
     ...
     */
    static evaluatePolicyLocally(reputation, policy) {
        return (0, policyEngine_1.evaluateEligibility)(reputation, policy);
    }
    /**
    ...
    static verifyProofLocally(proof) {
        return (0, canonicalMessage_1.verifyLogCryptographically)({
