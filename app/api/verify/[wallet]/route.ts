  ...
  try {
    ...
    const allProcessedLogs = logs.map((l) => {
      ...
      return {
        ...
        submission_receipt: l.submission_receipt || null,
        server_observed_at: validity.details.serverObservedAt || null,
        submission_receipt_valid: validity.details.submissionReceiptValid,
