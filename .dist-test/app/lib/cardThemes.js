...
exports.DEFAULT_CARD_THEME = exports.CARD_THEMES = void 0;
exports.getCardTheme = getCardTheme;
exports.CARD_THEMES = {
    steel: {
        id: 'steel',
        name: 'Raw Steel',
        ...
        baseTone: '#12141a',
        surfaceGradient: 'linear-gradient(135deg, #1e222d 0%, #151820 40%, #252a37 70%, #12141b 100%)',
    ...
    titanium: {
        ...
        baseTone: '#181b22',
        surfaceGradient: 'linear-gradient(145deg, #242934 0%, #1a1d26 45%, #2a313f 80%, #171922 100%)',
    ...
    obsidian: {
        ...
        baseTone: '#08090c',
        surfaceGradient: 'linear-gradient(150deg, #12141b 0%, #08090c 50%, #151720 85%, #050608 100%)',
    ...
    chrome: {
        ...
        baseTone: '#1e2129',
        surfaceGradient: 'linear-gradient(135deg, #3d4353 0%, #1c1f27 30%, #50586d 60%, #181a21 100%)',
    ...
    platinum: {
        ...
        baseTone: '#161922',
        surfaceGradient: 'linear-gradient(140deg, #2a303f 0%, #181b24 50%, #343c4e 80%, #14161f 100%)',
    ...
    carbon: {
        ...
        baseTone: '#0d0e12',
        surfaceGradient: 'linear-gradient(135deg, #171920 0%, #0d0e12 50%, #1e2029 80%, #0a0b0e 100%)',
    ...
    reactor: {
        ...
        baseTone: '#0a1017',
        surfaceGradient: 'linear-gradient(145deg, #101c2b 0%, #091119 50%, #15263a 85%, #060b10 100%)',
    ...
    solar: {
        ...
        baseTone: '#16130b',
        surfaceGradient: 'linear-gradient(140deg, #2e2413 0%, #15120a 50%, #3d3018 85%, #100e07 100%)',
    ...
    deep_space: {
        ...
        baseTone: '#0c0e18',
        surfaceGradient: 'linear-gradient(145deg, #181d33 0%, #0b0d18 50%, #1f2746 85%, #080912 100%)',
    ...
    prototype: {
        ...
        baseTone: '#15171a',
        surfaceGradient: 'linear-gradient(135deg, #22252a 0%, #141519 45%, #2a2e35 80%, #101215 100%)',
...
exports.DEFAULT_CARD_THEME = exports.CARD_THEMES.steel;
function getCardTheme(themeId) {
    if (!themeId)
        return exports.DEFAULT_CARD_THEME;
    return exports.CARD_THEMES[themeId] || exports.DEFAULT_CARD_THEME;
}
