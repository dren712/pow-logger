...
export async function GET(
  ...
  const portableEnvelope = {
    ...
    protocol: 'PROVN',
    version: proof.protocol_version || 2,
    proof_id: proof.id,
    ...
    claim: {
      ...
      domain: proof.domain || 'provn-sol.vercel.app',
    ...
    offline_validity_report: validity,
    verification_guide: {
      cli_command: `npx provn verify proof-${proof.id}.json`,
